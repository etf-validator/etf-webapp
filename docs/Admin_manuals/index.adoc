...
| *Status* | in review
| *Date* | 2017-04-20
| *Description* | This manual is intended for administrators who want to set up an organization internal deployment of the ETF validator. Basic knowledge about Apache Tomcat 8 are required.
