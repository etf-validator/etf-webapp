...
#JFH: I did not find information about the types. Please correct or complete this section.#

==== #label#
#description#

ID:: #EID...#
Item:: #Test Step or Test Assertion#

[[soapui-attachments]]
=== Attachments

#JFH: describe attachments that are referenced from SoapUI test results and their types.#
...
NOTE: Currently, the library provides one pre-defined map for INSPIRE Download Services (INSPIRE-DS_NS). Additional namespace maps for specific topics will be added in the future for convenience.
