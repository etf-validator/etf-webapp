...
#CP: Add more information how to use the GmlGeoX functions. Sources: https://github.com/interactive-instruments/etf-gmlgeox/blob/master/Readme.md and https://github.com/interactive-instruments/etf-webapp/wiki/dev_manual_modules_gmlgeox#

#JFH: Publish JavaDoc and link from here#
