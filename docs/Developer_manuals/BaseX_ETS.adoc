...
The
link:https://github.com/interactive-instruments/etf-ets-repository[etf-ets-repository]
provides a
...
a Schematron file into an ETF Executable Test Suite for the BaseX test driver.
The Stylesheet maps all information that are found in the Schematron file, but
