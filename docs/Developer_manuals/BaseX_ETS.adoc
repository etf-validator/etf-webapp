...
The complete documentation of the module is available in the JavaDoc description. #JFH: Publish JavaDoc and link from here#
...
As a result, a test developer of this module must be very careful regarding which geometry types are supported for processing, and whether the computation is robust and exact or not. Please consult the Javadoc #JFH: add link# for additional details.
